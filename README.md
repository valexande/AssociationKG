...
# GitHub does not allow us to upload big files, please find the aforementioned code here: [http://lpis.csd.auth.gr/ontologies/2022/AssociationKG/code.zip](http://lpis.csd.auth.gr/ontologies/2022/AssociationKG/code.zip) and the subgraphs + results + patterns + relations here: [http://lpis.csd.auth.gr/ontologies/2022/AssociationKG/dataset_results.zip](http://lpis.csd.auth.gr/ontologies/2022/AssociationKG/dataset_results.zip)
